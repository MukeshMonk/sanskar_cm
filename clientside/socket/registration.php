<?php 
	...
	$ipp=10;
	$sql2="SELECT COUNT(cm_register.id) as tot_std FROM `cm_register` LEFT JOIN cm_classes ON cm_register.enq_class=cm_classes.id	WHERE cm_register.id!=0 ".$cond.$fiter_condition.$ord_cond;
	//echo $sql2; exit;
