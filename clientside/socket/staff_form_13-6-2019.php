	  ...
	  if($name!= NULL)
	  {
		...
		if($item_id=="")
		{
			...
			if($password_faculty==""){
				...
				$ins_fac2= $obj_model_log1->execute("INSERT",false,"INSERT INTO cm_users (username,pass,firstname,lastname,email,phone,status) VALUES ('$login_id','$password_faculty','$name','$last_name','$email','$m_no','Active')");
