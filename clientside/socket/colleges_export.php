<?php 
	...
	else
	{
	 ...
	 $obj_model_hm = $app->load_model("cm_colleges");
	 ...
	 if(count($result)>0)
	 {
			...
			//SETUP EXCEL HEADS
			$ExeclHeads=array("Sr.","Name","Email","Website","Phone","Affiliation","Address","Status","Added On","Last Updated");
	...
	$fields=array("sr","name","email","website","phonenumber","affiliation_number","address","status","added_on","last_updated");
		
		$excel_postfix="colleges_".time();
