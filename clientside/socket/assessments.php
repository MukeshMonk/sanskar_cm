<?php 
	...
	while($row = mysql_fetch_array( $rs ))
	{
		...
		$terms_btn='<a class="btn btn-info btn-xs btn-default-custom md-trigger pull-left" href="javascript:void(0)"   data-toggle="tooltip" data-title="A,B,C,D title" data-placement="top" data-original-title="" title="" onclick="loadterms_assessment(\''.$id_enc.'\');"><i class="fa fa-plus"></i> Terms</a>';
		...
		$action='<div class="btn-group">
										...
										onclick="javascript:edit_assessments(\''.$id_enc.'\')"><i class="glyphicon glyphicon-edit"></i> Edit</a></li>
                                          <li><a href="javascript:void(0);"  onclick="javascript:confrim_del_ajax({\'ac_id\':\''.$id_enc.'\', \'connector\':\'delete_assessments\'})"><i class="glyphicon glyphicon-trash"></i> Delete</a></li>
                                        </ul>
                                      </div>';
