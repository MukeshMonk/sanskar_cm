<?php 
	...
	$sql="SELECT `cm_roles`.* FROM `cm_roles` WHERE id!=0 and status!=2".$cond.$ord_cond;
...

	{
		...
		$action='<div class="btn-group">
										...
										onclick="javascript:edit_roles(\''.$id_enc.'\')"><i class="glyphicon glyphicon-edit"></i> Edit</a></li>

                                          <li><a href="javascript:void(0);"  onclick="javascript:confrim_del_ajax({\'ac_id\':\''.$id_enc.'\', \'connector\':\'delete_roles\'})"><i class="glyphicon glyphicon-trash"></i> Delete</a></li>
