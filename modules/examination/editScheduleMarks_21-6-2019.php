    ...
    <div class="col-xxl-12 col-md-12">
      <div class="panel panel-default">
            ...
            <thead>
              <tr>
				...
				if(count($this->app->ent_terms)>0)
				{
					...
					{
            echo '<th style="width:10%;" class="sort-column">'.$terms['act_name'].'('.$terms['max_mark'].')</th>';
        ...
        $status_array1=array(""=>"Select Status","AB"=>"AB","NA"=>"NA","EX"=>"EX","ML"=>"ML","OL"=>"OL");
            ...
            //echo "<pre>";print_r($marks_txt); exit;
						echo '<td><input type="text" class="form-control edit_marks" data-marks="'.$terms['max_mark'].'"  data-cmarks="'.$marks_txt['marks'].'" name="marks1_'.$student['id'].'[]" value="'.$marks_txt['marks'].'"  /></td>';
