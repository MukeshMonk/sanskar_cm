          ...
          <div class="col-md-10">
            ...
            <div class="col-md-4">
              ...
              <div class='input-group date'>
                ...
                <? $this->app->htmlBuilder->buildTag("input", array("type"=>"text","class"=>"form-control  indatepicker2 required", "title"=>"Please Select Joining Date"), "joining_date");?>
          ...
          <div class="col-md-4">
            ...
            <label for="field-1" class="control-label">Gender<span class="mandatory">*</span></label>
              <div class="checkbox col-md-6 chk-padding">
                <input type="radio" id="male" name="gender" value="male" <?php echo  (isset($studentedit['gender']) && $studentedit['gender'] == "male" )? "checked" : ''; ?> required="required" title="Please Select Gender">
