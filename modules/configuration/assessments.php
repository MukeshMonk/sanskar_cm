    ...
    <div class="col-xxl-12 col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title mb0">Assessment </h4>
            ...
            <div class="col-md-6 col-sm-12 search-container padding-bottom15">
              <div class="input-group"> <span class="input-group-btn ui-select">
                <select class="form-control" id="search_by">
                  <option value="asses_name">Name</option>
          ...
          <table class="table table-striped table-bordered" id="cf_table_list" data-method="assessments">
            <thead>
              <tr>
                ...
                <th style="width:5%;" class="sort-column">Terms</th>
                <th style="width:8%;" class="sort-column">Name <span class="sort-wrap"> <a href="#" class="asc" data-field="asses_name" data-val="asc"><i class="fa fa-caret-up"></i></a> <a href="#" class="desc" data-field="asses_name" data-val="desc"><i class="fa fa-caret-down"></i></a> </span> </th>
...
.course_name" data-val="desc"><i class="fa fa-caret-down"></i></a> </span> </th>
                <th style="width:12%;" class="sort-column">Marks <span class="sort-wrap"> <a href="#" class="asc" data-field="marks" data-val="asc"><i class="fa fa-caret-up"></i></a> <a href="#" class="desc" data-field="marks" data-val="desc"><i class="fa fa-caret-down"></i></a> </span> </th>
...
<div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content">
      <? $this->app->htmlBuilder->buildTag("form", array("action"=>"","class"=>""), "frm_assessments");?>
      <? $this->app->htmlBuilder->buildTag("input", array("type"=>"hidden", "value"=>"assessments_form"), "connector");?>
      <? $this->app->htmlBuilder->buildTag("input", array("type"=>"hidden", "value"=>$this->record_id), "record_id");?>
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title"><span>Add</span> <strong>Assessment</strong> </h4>
      </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control required" id="asses_name" name="asses_name" title="Name Required" placeholder="Name">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="number" class="form-control required" id="marks" name="marks">
            </div>
          </div>
        </div>
        <div class="row">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-info waves-effect waves-light" id="save_assessments">Save</button>
      </div>
...
<div id="class-terms_assessment-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
