          ...
          <div class="row">
            ...
            <div class="col-md-4">
	            <div class="form-group">
                  ...
                  <option value="Registration Done-Outside" <?php echo  (isset($studentedit['status']) && $studentedit['status'] == "Registration Done-Outside" )? 'selected="selected"' : ''; ?>>Registration Done-Outside</option>
