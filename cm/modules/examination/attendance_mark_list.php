          ...
          <table class="table table-striped table-bordered" id="cf_table_list" data-method="exam_sch">
            <thead>
              <tr>
                ...
                <th style="width:23.5%;" class="sort-column">Attendance Marks<span class="sort-wrap"> <a href="#" class="asc" data-field="cm_course.course_name" ><i class="fa fa-caret-up"></i></a> <a href="#" class="desc" data-field="cm_course.course_name" data-val="desc"><i class="fa fa-caret-down"></i></a> </span></th>
                <th style="width:23.5%;" class="sort-column">PDF Reports<span class="sort-wrap"> <a href="#" class="asc" data-field="cm_course.course_name" ><i class="fa fa-caret-up"></i></a> <a href="#" class="desc" data-field="cm_course.course_name" data-val="desc"><i class="fa fa-caret-down"></i></a> </span></th>
                <th style="width:23.5%;" class="sort-column">Academic Year<span class="sort-wrap"> <a href="#" class="asc" data-field="act_date" data-val="asc"><i class="fa fa-caret-up"></i></a> <a href="#" class="desc" data-field="act_date" data-val="desc"><i class="fa fa-caret-down"></i></a> </span></th>
                <th style="width:23.5%;" class="sort-column">Class Section<span class="sort-wrap"> <a href="#" class="asc" data-field="act_date" data-val="asc"><i class="fa fa-caret-up"></i></a> <a href="#" class="desc" data-field="act_date" data-val="desc"><i class="fa fa-caret-down"></i></a> </span></th>
              </tr>
            </thead>
            <tbody>
            </tbody>
