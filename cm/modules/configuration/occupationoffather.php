    ...
    <div class="col-xxl-12 col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title mb0">Occupation </h4>
...
<div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content">
      <? $this->app->htmlBuilder->buildTag("form", array("action"=>"","class"=>""), "frm_occupationoffather");?>
      <? $this->app->htmlBuilder->buildTag("input", array("type"=>"hidden", "value"=>"occupationoffather_form"), "connector");?>
      <? $this->app->htmlBuilder->buildTag("input", array("type"=>"hidden", "value"=>$this->record_id), "record_id");?>
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title"><span>Add</span> <strong>Occupation</strong> </h4>
      </div>
      <div class="modal-body">
        <div id="occupationoffather_response"></div>
        <div class="row">          
          <div class="col-md-12">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-info waves-effect waves-light" id="save_occupationoffather">Save</button>
      </div>
