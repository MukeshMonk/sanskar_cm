          ...
          <table class="table table-striped table-bordered" id="cf_table_list" data-method="smstemplates">
            <thead>
              <tr>
                ...
                <th style="width:12%;" class="sort-column">Message <span class="sort-wrap"> <a href="#" class="asc" data-field="message" data-val="asc"><i class="fa fa-caret-up"></i></a> <a href="#" class="desc" data-field="message" data-val="desc"><i class="fa fa-caret-down"></i></a> </span></th>
...
<div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content">
      <? $this->app->htmlBuilder->buildTag("form", array("action"=>"","class"=>""), "frm_smstemplates");?>
      <? $this->app->htmlBuilder->buildTag("input", array("type"=>"hidden", "value"=>"smstemplates_form"), "connector");?>
      <? $this->app->htmlBuilder->buildTag("input", array("type"=>"hidden", "value"=>$this->record_id), "record_id");?>
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title"><span>Add</span> <strong>Sms Templates</strong> </h4>
      </div>
      <div class="modal-body">
        <div id="smstemplates_response"></div>
        <div class="row">          
          <div class="col-md-12">
       ...
       <div class="row">          
          <div class="col-md-12">
            <div class="form-group">
              <label for="field-1" class="control-label">Message<span class="mandatory">*</span></label>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-info waves-effect waves-light" id="save_smstemplates">Save</button>
      </div>
