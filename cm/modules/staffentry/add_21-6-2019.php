        ...
        <div class="col-md-4">
          ...
          <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <? $this->app->htmlBuilder->buildTag("select", array("class"=>"select2", "values"=>$this->app->bank_dd), "bank_name");?>
            </div>
          </div>
           ...
           <div class="col-md-4">
            ...
            <div class="form-group">
              ...
              <? $this->app->htmlBuilder->buildTag("input", array("type"=>"text","class"=>"form-control", "title"=>"Account No Required","placeholder"=>"Account No"), "acc_no");?>
