        ...
        <div class="panel-body">
          <div class="row mb20">
            ...
            <div class="col-md-6 col-sm-12 actions-container padding-bottom15"> 
            	...
            	<a class="btn btn-danger btn-default-custom pull-right"  id="delete_action"  href="javascript:void(0);" data-act="muliple_delete" data-connector="delselected_medicalleaves"  title="Delete"><i class="fa fa-trash-o"></i></a> 
            	<a class="btn btn-default btn-default-custom pull-right"  id="delete_action"  href="javascript:void(0);" onclick="dizzi_exporter('1','medicalleaves_export');"><i class="fa fa-download"></i></a> 
            </div>
          </div>
          
          <table class="table table-striped table-bordered" id="cf_table_list" data-method="medicalleaves">
            <thead>
              <tr>
                ...
                <th style="width:5%;" class="sort-column">Doctor Name <span class="sort-wrap"> <a href="#" class="asc" data-field="doctor_name" data-val="asc"><i class="fa fa-caret-up"></i></a> <a href="#" class="desc" data-field="doctor_name" data-val="desc"><i class="fa fa-caret-down"></i></a> </span></th>
...
<div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content">
      <? $this->app->htmlBuilder->buildTag("form", array("action"=>"","class"=>""), "frm_medicalleaves");?>
      <? $this->app->htmlBuilder->buildTag("input", array("type"=>"hidden", "value"=>"medicalleaves_form"), "connector");?>
      <? $this->app->htmlBuilder->buildTag("input", array("type"=>"hidden", "value"=>$this->record_id), "record_id");?>
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        <h4 class="modal-title"><span>Add</span> <strong>Medical Leave</strong> </h4>
      </div>
      <div class="modal-body">
        <div id="medicalleaves_response"></div>
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label for="field-1" class="control-label">Form No<span class="mandatory">*</span></label>
              <input type="text" class="form-control required" id="form_no" name="form_no1" title="Short Form No" placeholder="Form No">
            </div>
          </div>          
        </div>
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label for="field-1" class="control-label">Doctor Name<span class="mandatory">*</span></label>
              <input type="text" class="form-control required" id="doctor_name" name="doctor_name1" title="Short Doctor Name" placeholder="Doctor Name">
            </div>
          </div>          
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label for="field-1" class="control-label">Student ID No.<span class="mandatory">*</span></label>
              <input type="text" class="form-control required" id="student_id1" name="student_id1" >
            </div>
          </div>          
        </div>         
      </div>
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-info waves-effect waves-light" id="save_medicalleaves">Save</button>
      </div>
