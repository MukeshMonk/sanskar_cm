    ...
    <div class="col-xxl-12 col-md-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4 class="panel-title mb0">Registration </h4>
      ...
      <div class="row">
       ...
       <div class="row">
        ...
        <div class="form-group">
         ...
         <? $this->app->htmlBuilder->buildTag("select", array("class"=>"form-control sel_class gen_conditionalval", "values"=>array(""=>"Select Status","Online Pending"=>"Online Pending","Registration Done - Fees Pending"=>"Registration Done - Fees Pending","Registration Done - Fees Paid"=>"Registration Done - Fees Paid","Admission Granted"=>"Admission Granted","Admission Rejected"=>"Admission Rejected","Registration Done-Outside"=>"Registration Done-Outside","Deleted"=>"Deleted")), "status_sel");?>
       ...
       <div class="row">
        ...
        <div class="form-group">
         ...
         <div class="input-group date">
          ...
          <div class="row mb20">
            <div class="col-md-7 col-sm-12 search-container padding-bottom15">
              <div class="input-group"> <span class="input-group-btn ui-select">
                <select class="form-control" id="search_by">
                   	  <option value="cm_register.first_name">Name</option>
                      <option value="cm_register.reg_date">Registration Date</option>
                      <option value="cm_register.address">Address</option>
                      <option value="cm_register.city">City</option>
                </select>
                </span>
            ...
            <div class="col-md-2 col-sm-12"><input type="text" name="total_student" class="form-control" id="total_student" value="Total Students (<?php echo $this->app->total_students ?>)" disabled></div>
            <div class="col-md-3 col-sm-12 actions-container padding-bottom15"> <a class="btn btn-success btn-default-custom md-trigger pull-left" href="<?php echo CMX_ROOT . '/admissionentry/registration/add/'; ?>" ><i class="fa fa-plus"></i> Add New</a> <a class="btn btn-danger btn-default-custom pull-right"  id="delete_action"  href="javascript:void(0);" data-act="muliple_delete" data-connector="delselected_registration"  title="Delete"><i class="fa fa-trash-o"></i></a> <a class="btn btn-default btn-default-custom pull-right"  id="delete_action"  href="javascript:void(0);" onclick="dizzi_exporter('1','registration_export');"><i class="fa fa-download"></i></a> </div>
          </div>
          <table class="table table-striped table-bordered" id="cf_table_list" data-method="registration">
            <thead>
              <tr>
                ...
                <th style="width:12%;" class="sort-column">Status<span class="sort-wrap"> <a href="#" class="asc" data-field="cm_register.status" ><i class="fa fa-caret-up"></i></a> <a href="#" class="desc" data-field="cm_register.status" data-val="desc"><i class="fa fa-caret-down"></i></a> </span></th>
                ...
                <th style="width:12%;" class="sort-column">Reg. No<span class="sort-wrap"> <a href="#" class="asc" data-field="cm_register.id" data-val="asc"><i class="fa fa-caret-up"></i></a> <a href="#" class="desc" data-field="cm_register.id" data-val="desc"><i class="fa fa-caret-down"></i></a> </span></th>
                ...
                <th style="width:12%;" class="sort-column">Reg. Date<span class="sort-wrap"> <a href="#" class="asc" data-field="cm_register.reg_date" data-val="asc"><i class="fa fa-caret-up"></i></a> <a href="#" class="desc" data-field="cm_register.reg_date" data-val="desc"><i class="fa fa-caret-down"></i></a> </span></th>
...
<div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog dialog-width-max">
    <div class="modal-content">
      <? $this->app->htmlBuilder->buildTag("form", array("action"=>"","class"=>""), "frm_registration");?>
      <? $this->app->htmlBuilder->buildTag("input", array("type"=>"hidden", "value"=>"registration_form"), "connector");?>
      ...
      <div class="modal-header">
        ...
        <h4 class="modal-title"><span>Add</span> <strong>Registration Admission</strong> </h4>
      </div>
      <div class="modal-body">
        ...
        <div class="col-md-4">
            <div class="form-group">
              ...
              <div class='input-group date'>
                <input id="enq_date" name="enq_date"type="text" value="" class="form-control indatepicker">
                <span class="input-group-addon"> <i class="font-icon font-icon-calend"></i> </span> </div>
            </div>
          </div>         
            <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control required" id="enq_no" name="enq_no" title="Registration No Required" placeholder="Registration No" >
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
        ...
        <div class="row"> 
             <div class="col-md-4">
		        <div class="form-group">
	              <label for="field-1" class="control-label">Candidate Image<span class="mandatory">*</span></label>
	              <input type="file" class="form-control" id="stud_image" name="stud_image">
	            </div>
	        </div>   
            <div class="col-md-4">
            <div class="form-group">
              <label for="field-1" class="control-label">Email Id<span class="mandatory">*</span></label>
              <input type="text" class="form-control required" id="email_id" name="email_id" title="Email Id Required" placeholder="Email Id" >
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group"> 
            <label for="field-1" class="control-label">Marital Status<span class="mandatory">*</span></label>
        ...
        <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control required" id="first_name" name="first_name" title="First Name Required" placeholder="First Name">
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control required" id="last_name" name="last_name" title="Last Name Required" placeholder="Last Name" >
            </div>
          </div>
        </div>
        <div class="row">          
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label for="field-1" class="control-label">Place Of Birth<span class="mandatory">*</span></label>
              <input type="text" class="form-control required" id="email_id" name="email_id" title="Email Id Required" placeholder="Email Id" >
            </div>
          </div>
        </div>
        ...
        <div class="row">          
         ...
         <div class="col-md-4">
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label for="field-1" class="control-label">Mother Tongue<span class="mandatory">*</span></label>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="profession" name="profession" title="Profession Required" placeholder="Father Profession" >
            </div>
          </div>
            <div class="col-md-4">
            <div class="form-group">
              <label for="field-1" class="control-label">Nationality<span class="mandatory">*</span></label>
              <input type="text" class="form-control required" id="mother_name" name="mother_name" title="Mother Name Required" placeholder="Mother Name" >
            </div>
          </div>
          </div>
        <div class="row">
        ...
        <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control required" id="district" name="district" title="District Required" placeholder="District" >
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
        ...
        <div class="col-md-4">
            <div class="form-group">
              <label for="field-1" class="control-label">Annual Income of guardian<span class="mandatory">*</span></label>
              <input type="text" class="form-control required" id="pin" name="pin" title="PIN Required" placeholder="PIN" >
            </div>
          </div>
        </div>
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label for="field-1" class="control-label">NAME OF EXAM<span class="mandatory">*</span></label>
          ...
          <div class="col-md-4">
	            <div class="form-group">
		          <label  class="control-label">Name of board</label>
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label for="field-1" class="control-label">Name of school / college <span class="mandatory">*</span></label>
              <input type="text" class="form-control required" id="pr_grade" name="pr_grade" title="Percentage/Grade Required" placeholder="Percentage/Grade obtained" >
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-4">
		        <div class="form-group">
		          <label  class="control-label">Program of Interest<span class="mandatory">*</span></label>
		           <? $this->app->htmlBuilder->buildTag("select", array("class"=>"select2", "values"=>$this->app->branch_dd), "poi");?>
				</div>
	        </div>
          <div class="col-md-4">
		        <div class="form-group">
		          <label  class="control-label">Semester<span class="mandatory">*</span></label>
		           <? $this->app->htmlBuilder->buildTag("select", array("class"=>"select2", "values"=>$this->app->sem_dd), "sem_adm");?>
				</div>
	        </div>
          <div class="col-md-4">
	            <div class="form-group">
