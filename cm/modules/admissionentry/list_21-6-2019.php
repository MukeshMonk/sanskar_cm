      ...
      <div class="row">
       ...
       <div class="row">
        ...
        <div class="form-group">
         ...
         <? $this->app->htmlBuilder->buildTag("select", array("class"=>"form-control sel_class gen_conditionalval", "values"=>array(""=>"Select Status","Online Pending"=>"Online Pending","Registration Done - Fees Pending"=>"Registration Done - Fees Pending","Registration Done - Fees Paid"=>"Registration Done - Fees Paid","Admission Granted"=>"Admission Granted","Admission Rejected"=>"Admission Rejected","Deleted"=>"Deleted")), "status_sel");?>
