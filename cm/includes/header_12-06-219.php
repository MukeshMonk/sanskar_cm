      ...
      <div class="site-header-content-in">
        <div class="site-header-shown">
          ...
          <div class="dropdown user-menu">
            <button class="dropdown-toggle" id="dd-user-menu" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img src="img/avatar-2-64.png" alt=""> Admin </button>
