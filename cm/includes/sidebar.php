	    ...
	    <ul class="side-menu-list">
	     ...
	     <!--   <li class="gold">
	        ...
	        <li class="grey with-sub">
	            ...
	            <ul>
	                <li><a href="wsdindex.html#"><span class="lbl">Level 1</span></a></li>
	                <li><a href="wsdindex.html#"><span class="lbl">Level 1</span></a></li>
	                <li class="with-sub">
	                    <span>
	                    ...
	                    <ul>
	                        <li><a href="wsdindex.html#"><span class="lbl">Level 2</span></a></li>
	                        <li><a href="wsdindex.html#"><span class="lbl">Level 2</span></a></li>
	                        <li class="with-sub">
	                            <span>
	                            ...
	                            <ul>
	                                <li><a href="wsdindex.html#"><span class="lbl">Level 3</span></a></li>
	                                <li><a href="wsdindex.html#"><span class="lbl">Level 3</span></a></li>
	                            </ul>
	                        </li>
	                    </ul>
