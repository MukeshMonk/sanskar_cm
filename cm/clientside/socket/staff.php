<?php 
	...
	$sql="select * from staff where id!=0".$cond.$ord_cond;

	//$sql="select * from staff where designation in (select id from cm_designations  where staff_type='General') and  id!=0".$cond.$ord_cond;
...

	{
		...
		$mobile_no=$row['mobile_no'];
		 ...
		 if($row["staff_image"]!="")
			...
			$hltb_path="../images/avatar-1-32.png";
		...
		$action='<div class="btn-group">
                                        ...
                                        <li><a href="'.CMX_ROOT . '/staffentry/staff/add/edit/'.$id_enc.'/"  
