<?php
	...
	$ipp=10;
	$sql="SELECT * FROM cm_enter_attendance_marks LEFT JOIN exam_schedule ON exam_schedule.id = cm_enter_attendance_marks.exam_id WHERE exam_schedule.is_attendance='Yes' and exam_schedule.status!='2' group by exam_id".$cond.$ord_cond;
	...
	while($row = mysql_fetch_array( $rs ))
	{
		...
		$enter_mark_btn='<a href="'.CMX_ROOT.'/examination/attendance_mark/add/'.$id_enc.'/"><i class="glyphicon glyphicon-edit"></i> Attendance Marks</a>';
