<?php 
	...
	else
	{
	 ...
	 $obj_model_hm = $app->load_model("cm_representationalattandence");
	 ...
	 if(count($result)>0)
	 {
			...
			//SETUP EXCEL HEADS
			$ExeclHeads=array("Sr.","Event","Start Date","End Date","Student Id","Status","Added On","Last Updated");
	...
	$fields=array("sr","event","start_date","end_date","student_idno","status","added_on","last_updated");
		
		$excel_postfix="representationalattandence_".time();
