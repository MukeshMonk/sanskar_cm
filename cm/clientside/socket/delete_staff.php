<?php
	...
	if($acd_id>0)
	{
			...
			$obj_model_log = $app->load_model("staff",$acd_id);
			$obj_model_log->map_fields($update_field);
			$ins=$obj_model_log->execute("DELETE");
	echo $obj_JSON->encode(array("RESULT"=>"SUCCESS","MSG"=>"Student Deleted Successfully.","retriver"=>"staff"));
	}
	else
	{
