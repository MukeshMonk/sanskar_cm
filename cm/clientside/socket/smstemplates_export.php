<?php 
	...
	else
	{
	 ...
	 $obj_model_hm = $app->load_model("cm_smstemplates");
	 ...
	 if(count($result)>0)
	 {
			...
			//SETUP EXCEL HEADS
			$ExeclHeads=array("Sr.","Name","Message","Status","Added On","Last Updated");
	...
	$fields=array("sr","name","message","status","added_on","last_updated");
		
		$excel_postfix="smstemplates_".time();
