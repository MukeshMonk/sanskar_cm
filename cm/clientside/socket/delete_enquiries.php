<?php
...

	{
			...
			$obj_model_log = $app->load_model("cm_enquiries",$acd_id);

			$obj_model_log->map_fields($update_field);

			$ins=$obj_model_log->execute("UPDATE");

	echo $obj_JSON->encode(array("RESULT"=>"SUCCESS","MSG"=>"Admission Enquiries Deleted Successfully.","retriver"=>"enquiries"));
