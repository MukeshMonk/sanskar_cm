<?php 
	...
	else
	{
	 ...
	 $obj_model_hm = $app->load_model("cm_academicyears");
	 ...
	 if(count($result)>0)
	 {
			...
			//SETUP EXCEL HEADS
			$ExeclHeads=array("Sr.","Short Name","Name","From Date","To Date","Status","Added On","Last Updated");
	...
	$fields=array("sr","short_name","name","frm_date","to_date","status","added_on","last_updated");
		
		$excel_postfix="academics_".time();
